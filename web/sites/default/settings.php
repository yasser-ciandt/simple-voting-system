 ...
 * @endcode
 */
$settings['hash_salt'] = 'zSivA2VcQXXUopUC5wqXDuEyIT38exD3Njm3mdLzTXnw1_ZXYOEmGwhCv3j2Gk_QivLUl16sHA';
 ...
 * $settings['trusted_host_patterns'] = [
 *   '^example\.com$',
 *   '^.+\.example\.com$',agregar estas url tambien en trusted_host_patterns https://localhost:32772 y http://localhost:32771
 *   '^example\.org$',
 *   '^.+\.example\.org$',
 * ];
 * @endcode
